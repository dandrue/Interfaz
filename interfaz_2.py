...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.label_3, 7, 1, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.gridLayout_3.addWidget(self.label_6, 7, 0, 1, 1, QtCore.Qt.AlignLeft)
        ...
        self.gridLayout_4.addWidget(self.pushButton_2, 5, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.pushButton_4.clicked.connect(self.user_vel)
        self.pushButton_5.clicked.connect(self.user_current)
    ...
    def user_vel(MainWindow, my_drive):
        Functionalities.user_vel(MainWindow, my_drive)

    def user_current(MainWindow, my_drive):
        Functionalities.user_current(MainWindow, my_drive)
